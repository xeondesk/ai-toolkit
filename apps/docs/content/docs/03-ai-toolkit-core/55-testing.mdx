...
- `MockEmbeddingModelV3`: A mock embedding model using the [embedding model v3 specification](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/provider/src/embedding-model/v3/embedding-model-v3.ts).
- `MockLanguageModelV3`: A mock language model using the [language model v3 specification](https://github.com/khulnasoft/ai-toolkit/blob/main/packages/provider/src/language-model/v3/language-model-v3.ts).
